...
/* ----------------------------------------------------------------------------
 *                   Geomagnetic WS1-2 Configuration
 *--------------------------------------------------------------------------- */


#define YAS_WS1_2_MAGCALIB_DISTORTION_1	(20)
#define YAS_WS1_2_MAGCALIB_DISTORTION_2	(15)
#define YAS_WS1_2_MAGCALIB_DISTORTION_3	(10)
#define YAS_WS1_2_MAG_STATIC_MATRIX	{9521, 230, 548, 82, 9852, -212, 107, 42, 10667}


/* ----------------------------------------------------------------------------
 *                   Geomagnetic LAB Configuration
 *--------------------------------------------------------------------------- */


#define YAS_LAB_MAGCALIB_DISTORTION_1	(20)
#define YAS_LAB_MAGCALIB_DISTORTION_2	(15)
#define YAS_LAB_MAGCALIB_DISTORTION_3	(10)
#define YAS_LAB_MAG_STATIC_MATRIX	{9702, 480, 631, -5, 9668, -181, 247, 181, 10669}
