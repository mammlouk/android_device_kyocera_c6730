...
static struct of_device_id gpio_keys_of_match_ws0[] = {
	{ .compatible = "gpio-keys_ws0", },
	{ },
};
MODULE_DEVICE_TABLE(of, gpio_keys_of_match);
MODULE_DEVICE_TABLE(of, gpio_keys_of_match_ws0);
...
static int __init gpio_keys_init(void)
{
	...
	{
		gpio_keys_device_driver.driver.of_match_table = gpio_keys_of_match_ws0;
	}
