...
static unsigned long sfh7776_als_lux_conversion(unsigned int vis, unsigned int ir)
{
    ...
    if(200 > ratio)
    {
        lux = 8903*vis/GAIN_VIS - 18062*ir/GAIN_IR;
        lux = lux / 1000 * GA_A / 100;
    }
    else if(576 > ratio)
    {
        lux = 5122*vis/GAIN_VIS - 6266*ir/GAIN_IR;
        lux = lux / 1000 * GA_E / 100;
    }
    else if(700 > ratio)
    {
        lux = 2541*vis/GAIN_VIS - 1788*ir/GAIN_IR;
        lux = lux / 1000 * GA_E / 100;
    }
    else if(1617 > ratio)
    {
        lux = 1962*vis/GAIN_VIS - 1213*ir/GAIN_IR;
    ...
    {
        lux = 3924*vis/GAIN_VIS - 1432*ir/GAIN_IR;
        lux = lux / 1000 * GA_C / 100;
    }
    else if(4042 > ratio)
    {
        lux = 7848*vis/GAIN_VIS - 1614*ir/GAIN_IR;
        lux = lux / 1000 * GA_C / 100;
    }
    else
    {
        lux = 15695*vis/GAIN_VIS;
