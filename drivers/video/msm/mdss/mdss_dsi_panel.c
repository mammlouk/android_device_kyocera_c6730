			...
			struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	if(hwver <= OEM_BOARD_WS2_TYPE){
		printk("LCD_Seq_for_Before_WS2\n");
		mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->on_cmds,
		"qcom,mdss-dsi-on-command_ws1", "qcom,mdss-dsi-on-command-state");
	}else{
		printk("LCD_Seq_for_After_Lab\n");
		mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->on_cmds,
		"qcom,mdss-dsi-on-command_lab", "qcom,mdss-dsi-on-command-state");
	}
/*
	mdss_dsi_parse_dcs_cmds(np, &ctrl_pdata->on_cmds,
...
*/
	...
	"qcom,mdss-dsi-on-command_refresh", "qcom,mdss-dsi-on-command-state");
