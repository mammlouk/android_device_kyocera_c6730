...
#define WLED_CABC_EN_REG(base)  (base + 0x60+ 0x6)
#define LED1_CABC_EN 0x80
#define LED1_CABC_DIS 0x00
...
static int __devinit qpnp_wled_init(struct qpnp_led_data *led)
{
	...
	/* dump wled registers */
	qpnp_led_masked_write(led, WLED_CABC_EN_REG(led->base), WLED_NO_MASK, LED1_CABC_EN);
...
static void qpnp_led_ctrl_offcharging(uint32_t color)
{
	...
	{
		led_g->cdev.brightness = led_g->mpp_cfg->current_setting;
	...
	{
		led_r->cdev.brightness = led_r->mpp_cfg->current_setting;
