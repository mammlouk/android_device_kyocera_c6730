...
static struct gpiomux_setting gpio_mhl_ext_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct gpiomux_setting gpio_mhl_ext_dp_id_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv  = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting gpio_rcv_on_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting gpio_gain_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting gpio_sel_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm_keypad_configs_ws1[] __initdata = {
	{
		.gpio = 106, /* VOL_UP_KEY_N */
		.settings = {
			[GPIOMUX_ACTIVE]    = &gpio_keys_active,
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
	{
		.gpio      = 0,		/* BLSP1 EXT_CABL_DET */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_mhl_ext_config,
		},
	},
	{
		.gpio      = 1,		/* BLSP1 EXT_DP_INT */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_mhl_ext_config,
		},
	},
	{
		.gpio      = 2,		/* BLSP1 EXT_DP_RST */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_mhl_ext_config,
		},
	},
	{
		.gpio      = 3,		/* BLSP1 EXT_DP_ID */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_mhl_ext_dp_id_config,
		},
	},
	{
	...
	{
		.gpio      = 23,         /* BLSP6 RCV_ON */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_rcv_on_config,
		},
	},
};

static struct msm_gpiomux_config msm_blsp_configs_ws1[] __initdata = {
	{
		.gpio      = 6,         /* BLSP2 I2C_SECO_SDA */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_i2c_seco_config,
	...
	},
	{
		.gpio      = 14,         /* BLSP4 SEL */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_sel_config,
		},
	},
	{
		.gpio      = 15,         /* BLSP4 GAIN */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_gain_config,
		},
	},
	{
		.gpio      = 16,         /* BLSP5 TP_RST_N */
...
void __init msm8226_init_gpiomux(void)
{
...
#endif
	if (OEM_get_board() < OEM_BOARD_WS1_1_TYPE)
	{
	...
	{
		msm_gpiomux_install(msm_keypad_configs_ws1,
				ARRAY_SIZE(msm_keypad_configs_ws1));
		msm_gpiomux_install(msm_blsp_configs_ws1, ARRAY_SIZE(msm_blsp_configs_ws1));
	}
